                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-12">
                    ...
                    <div className="flex flex-col space-y-4">
                        ...
                        <p className="text-sm leading-relaxed max-w-xs">
                            Crafting premium digital experiences through modern web architecture and design excellence.
                        </p>
                    ...
                    <div className="flex flex-col space-y-4">
                        ...
                        <ul className="space-y-3">
                            ...
                            <li><Link href="#" className="text-sm hover:text-white transition-colors">Components</Link></li>
                            <li><Link href="#" className="text-sm hover:text-white transition-colors">Templates</Link></li>
