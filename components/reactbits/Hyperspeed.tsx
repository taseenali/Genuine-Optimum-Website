...
interface EffectOptions {
    ...
    distortion?: 'mountainDistortion' | 'xyDistortion' | 'LongRaceDistortion' | 'turbulentDistortion' | 'turbulentDistortionStill' | 'deepDistortionStill' | 'deepDistortion';
    length?: number;
    roadWidth?: number;
    islandWidth?: number;
    lanesPerRoad?: number;
...
const Hyperspeed = ({ effectOptions = DEFAULT_EFFECT_OPTIONS }: HyperspeedProps) => {
        ...
        class App {
            ...
            loadAssets() {
                return new Promise(resolve => {
                    resolve(true); // SMAA Assets are handled internally by modern postprocessing
                });
            }
    ...
    `;
        ...
        (function () {
            ...
            const options = { ...DEFAULT_EFFECT_OPTIONS, ...effectOptions, colors: { ...DEFAULT_EFFECT_OPTIONS.colors, ...effectOptions.colors } } as any;
    ...
    return <div id="lights" ref={hyperspeed} className="lights"></div>;
};
